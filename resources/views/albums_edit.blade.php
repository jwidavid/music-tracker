...
@endif
    ...
    <div class="form-group">
        ...
        <input type="text" value="{{ old('name', $details->name) }}" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" placeholder="Enter Album Name" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" value="{{ old('number_of_tracks', $details->number_of_tracks) }}" class="form-control {{ $errors->has('number_of_tracks') ? 'is-invalid' : '' }}" name="number_of_tracks" placeholder="Enter Number of Tracks">
    </div>
    <div class="form-group">
        <label for="label">Label</label>
        <input type="text" value="{{ old('label', $details->label) }}" class="form-control {{ $errors->has('label') ? 'is-invalid' : '' }}" name="label" placeholder="Enter Label">
    </div>
    <div class="form-group">
        <label for="producer">Producer</label>
        <input type="text" value="{{ old('producer', $details->producer) }}" class="form-control {{ $errors->has('producer') ? 'is-invalid' : '' }}" name="producer" placeholder="Enter Producer Name">
    </div>
    <div class="form-group">
        <label for="genre">Genre</label>
        <input type="text" value="{{ old('genre', $details->genre) }}" class="form-control {{ $errors->has('genre') ? 'is-invalid' : '' }}" name="genre" placeholder="Enter the Genre">
    </div>
